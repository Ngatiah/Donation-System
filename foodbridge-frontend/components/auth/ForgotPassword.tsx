...
// //           </h2>
// //           <div>
// //             <label className="text-base font-semibold flex item-center mr-4-auto">
// //               Email
// //             </label>
// //             <input
// //               type="email"
...
// //             className="w-full px-4 py-2 text-white font-semibold rounded-md bg-indigo-600 hover:bg-indigo-700 mt-4"
// //           >
// //             Request Reset
// //           </button>
