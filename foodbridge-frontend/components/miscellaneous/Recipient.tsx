  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div  className="bg-white p-4 rounded shadow text-left">
            ...
            <div className="text-sm text-gray-600 mb-2 font-medium">donor's name</div>
            <div className="text-sm">Quantity: <strong>quantity</strong></div>
            {/* status : accept,decline,pending */}
            <button className="mt-2 bg-blue-500 text-white px-3 py-1 rounded text-sm">Accept</button>
          </div>
      </div>
  )
}
