...
function EditProfileForm<T extends FieldValues>({
  ...
  const filterFoodTypes = useCallback(
    ...
    [foodTypes]
  ); // Dependency on allFoodTypes to re-memoize if it changes
                  ...
                  <FormLabel className="capitalize">
                    {
                      editProfileFieldNames[
                        fieldName as keyof typeof editProfileFieldNames
                      ]
                    }
                  </FormLabel>
                  <FormControl>
                    {fieldName === "food_type" ? (
                      <AsyncSelect
                        ...
                        value={(field.value || []).map((val: string) => ({
                          value: val,
                          label: val,
                        }))} // Pre-selects based on current form value (array of strings)
                      ...
                      <Input
                        ...
                        type={
                          editProfileFieldTypes[
                            fieldName as keyof typeof editProfileFieldTypes
                          ]
                        }
                        {...field}
